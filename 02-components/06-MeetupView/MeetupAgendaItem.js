...
export default defineComponent({
  ...
  computed: {
    ...
    icon() {
      return `/assets/icons/icon-${this.agendaItemIcons[this.type]}.svg`;
    },
    title() {
      return this.agendaItem.title || this.agendaItemDefaultTitles[this.type];
    },
  },
